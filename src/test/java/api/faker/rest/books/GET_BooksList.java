...
public class GET_BooksList extends BaseTest {

    public static Response getBookList() {
        return HTTPMethods.getRequest("/api/v1/Books", header(), StatusCodes.SUCCESS);
    }
    ...
    public void exchangeRateCurrencyCheck() throws IOException {
        ...
        map.forEach((key, value) -> {
            ExtentReportUtil.extentLog.log(LogStatus.PASS, "Book id: " + key + "\n Book Name: " + value);
        });
